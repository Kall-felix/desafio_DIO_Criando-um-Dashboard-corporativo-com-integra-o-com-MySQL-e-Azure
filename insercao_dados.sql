...
insert into employee values ('John', 'B', 'Smith', 123456789, '1965-01-09', '731-Fondren-Houston-TX', 'M', 30000, 333445555, 5),
							('Lin', 'T', 'Wong', 333445555, '1955-12-08', '638-Voss-Houston-TX', 'M', 40000, 888665555, 5),
                            ('Alice', 'J', 'Souza', 999887777, '1968-01-19', '3321-Castle-Spring-TX', 'F', 25000, 987654321, 4),
                            ('Aurora', 'S', 'Rosa', 987654321, '1941-06-20', '291-Berry-Bellaire-TX', 'F', 43000, 888665555, 4),
                            ('Tulio', 'K', 'Silveira', 666884444, '1962-09-15', '975-Fire-Oak-Humble-TX', 'M', 38000, 333445555, 5),
                            ('Janiz', 'A', 'Beckler', 453453453, '1972-07-31', '5631-Rice-Houston-TX', 'F', 25000, 333445555, 5),
                            ('Mateus', 'V', 'Costa', 987987987, '1969-03-29', '980-Dallas-Houston-TX', 'M', 25000, 987654321, 4),
                            ('James', 'E', 'Won', 888665555, '1937-11-10', '450-Stone-Houston-TX', 'M', 55000, NULL, 1);

insert into dependent values (333445555, 'Maria', 'F', '1986-04-05', 'Daughter'),
							 (333445555, 'Julio', 'M', '1983-10-25', 'Son'),
                             (333445555, 'Tania', 'F', '1958-05-03', 'Spouse'),
                             (987654321, 'Tiago', 'M', '1942-02-28', 'Spouse'),
                             (123456789, 'Michel', 'M', '1988-01-04', 'Son'),
                             (123456789, 'Lara', 'F', '1988-12-30', 'Daughter'),
